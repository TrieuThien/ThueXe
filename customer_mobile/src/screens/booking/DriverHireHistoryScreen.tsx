...
type Props = NativeStackScreenProps<BookingStackParamList, "DriverHireHistory">;
        ...
        >
            <View style={styles.itemHeader}>
                <Text style={[styles.packageName, { color: theme.colors.text }]} numberOfLines={1}>
                    {(booking as any).packageName ?? "Thuê tài xế"}
                </Text>
...
export function DriverHireHistoryScreen({ navigation }: Props) {
    const { theme } = useTheme();

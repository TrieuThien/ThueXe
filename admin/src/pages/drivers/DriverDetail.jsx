                ...
                <>
                    ...
                    <section className="rounded-[28px] border border-slate-200 bg-white shadow-sm">
                        ...
                        <div className="overflow-x-auto">
                                ...
                                <table className="min-w-full divide-y divide-slate-200">
                                    <thead className="bg-slate-50">
                                        <tr className="text-left text-xs uppercase tracking-[0.2em] text-slate-500">
                                            <th className="px-6 py-4">STT</th><th className="px-6 py-4">Transaction ID</th><th className="px-6 py-4">Amount</th><th className="px-6 py-4">Wallet Balance</th><th className="px-6 py-4">Booking ID</th><th className="px-6 py-4">Type</th><th className="px-6 py-4">Description</th><th className="px-6 py-4">Date Created</th>
                                        </tr>
                                    </thead>
                            ...
                            {tab === "withdrawals" ? (
                                <table className="min-w-full divide-y divide-slate-200">
                                    <thead className="bg-slate-50"><tr className="text-left text-xs uppercase tracking-[0.2em] text-slate-500"><th className="px-6 py-4">STT</th><th className="px-6 py-4">Amount</th><th className="px-6 py-4">Wallet Before</th><th className="px-6 py-4">Wallet After</th><th className="px-6 py-4">Status</th><th className="px-6 py-4">Date Requested</th><th className="px-6 py-4">Date Settled</th><th className="px-6 py-4">Action</th></tr></thead>
